              ...
              <form className="w-full md:w-1/2 space-y-4">
                  <div className="flex flex-col">
                      ...
                      <input type="text" placeholder="Enter your title"
                             className="rounded-md border border-gray-300 px-3 py-4 focus:outline-none focus:ring-1 focus:ring-blue-500"
                             required/>
                  </div>
                  <div className="flex flex-col">
                      <label className="text-gray-700 mb-2 text-xl">Content</label>
                      <textarea placeholder="Enter your content"
                                className="rounded-md border border-gray-300 px-3 py-4 h-24 min-h-14 focus:outline-none focus:ring-1 focus:ring-blue-500"
                                required/>
                  </div>
                  <div className="flex flex-col">
